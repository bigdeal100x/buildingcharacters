...
// ==============================================
function preload() {
  // Load normal and stressed character images
  characterImage = loadImage('sasha.jpg'); // Replace with your normal image path
  stressedImage = loadImage('sasha-crumple.png'); // Replace with your stressed image path
}
...
function triggerStressedState() {
  ...
  // Change to stressed image
  character.img = stressedImage;
...
function moveCharacterToTarget() {
  ...
  if (!isStressed) {
    ...
    // Apply scale for direction (flip horizontally)
    character.scale.x = abs(character.scale.x) * characterDirection;
